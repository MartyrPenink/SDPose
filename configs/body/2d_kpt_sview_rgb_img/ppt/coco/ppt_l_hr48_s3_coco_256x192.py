...
model = dict(
    type='TopDown',
    pretrained='pretrained_model/hrnet/hrnet_w48-8ef0771d.pth',
    backbone=dict(
        type='HRNet_3stage',
        in_channels=3,
        extra=dict(
...
data_cfg = dict(
    ...
    #bbox_file='/root/feat_heatmap/val_bbox_id32081.json',
)
...
data = dict(
    ...
    test=dict(
        type='TopDownCocoDataset',
        ann_file=f'{data_root}/annotations/person_keypoints_val2017.json',
        #ann_file='/root/feat_heatmap/val_kpts_id32081.json',
        img_prefix=f'{data_root}/val2017/',
        data_cfg=data_cfg,
